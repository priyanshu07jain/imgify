...
const Header = () => {
  ...
  return (
    ...
    initial={{opacity:0.2,y:100}} transition={{duration:1}} whileInView={{opacity:1,y:0}} viewport={{once:true}}
     >
        ...
        <motion.p className=' text-center max-w-xl  m-auto mt-5'
  ...
  <img src={index%2==0?assets.sample_img_2:assets.sample_img_1} key={index} width={70} alt='' className='rounded hover:scale-105 transition-all duration-300 cursor-pointer  max-sm:w-10' 
whilehover={{scale:1.05,duration:0.1}}
  ...
  />
        ...
        >Genrated image from Imagify</motion.p>
    </motion.div>
  )
}
